...
/* #include "target_timer.h" */
/* #include "target_hw_counter.h" */
const unsigned_t TOPPERS_cfg_valueof_TSK_ACTIVATION_ETHER_OUTPUT_TASK_Os = ( 1U ); 
const unsigned_t TOPPERS_cfg_valueof_TSK_PRIORITY_ETHER_OUTPUT_TASK_Os = ( (TMAX_TPRI - ETHER_OUTPUT_PRIORITY) ); 
const unsigned_t TOPPERS_cfg_valueof_TSK_STKSZ_ETHER_OUTPUT_TASK_Os = ( ETHER_OUTPUT_STACK_SIZE ); 
const unsigned_t TOPPERS_cfg_valueof_TSK_ACTIVATION_ETHER_INPUT_TASK_Os = ( 1U ); 
const unsigned_t TOPPERS_cfg_valueof_TSK_PRIORITY_ETHER_INPUT_TASK_Os = ( (TMAX_TPRI - ETHER_INPUT_PRIORITY) ); 
const unsigned_t TOPPERS_cfg_valueof_TSK_STKSZ_ETHER_INPUT_TASK_Os = ( ETHER_INPUT_STACK_SIZE ); 
const unsigned_t TOPPERS_cfg_valueof_ISR_INTNO_if_tse_tx_handler_Os = ( INTNO_IF_TSE_TX ); 
const unsigned_t TOPPERS_cfg_valueof_ISR_INTPRI_if_tse_tx_handler_Os = ( INTPRI_IF_TSE ); 
const unsigned_t TOPPERS_cfg_valueof_ISR_INTNO_if_tse_rx_handler_Os = ( INTNO_IF_TSE_RX ); 
const unsigned_t TOPPERS_cfg_valueof_ISR_INTPRI_if_tse_rx_handler_Os = ( INTPRI_IF_TSE ); 
const unsigned_t TOPPERS_cfg_valueof_TSK_ACTIVATION_NET_TIMER_TASK_Os = ( 1U ); 
const unsigned_t TOPPERS_cfg_valueof_TSK_PRIORITY_NET_TIMER_TASK_Os = ( (TMAX_TPRI - NET_TIMER_PRIORITY) ); 
const unsigned_t TOPPERS_cfg_valueof_TSK_STKSZ_NET_TIMER_TASK_Os = ( NET_TIMER_STACK_SIZE ); 
const unsigned_t TOPPERS_cfg_valueof_ALM_AUTOSTART_ALARMTIME_OsAlarmAutostart_NET_TIMER_ALARM = ( (TIMER_CLOCK_HZ / 1000) ); 
const unsigned_t TOPPERS_cfg_valueof_ALM_AUTOSTART_CYCLETIME_OsAlarmAutostart_NET_TIMER_ALARM = ( (NET_TIMER_CYCLE * (TIMER_CLOCK_HZ / 1000)) ); 
