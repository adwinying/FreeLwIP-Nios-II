...
#define IPV4_ADDR_LOCAL			MAKE_IPV4_ADDR(172,24,11,32)
#define IPV4_ADDR_LOCAL_MASK		MAKE_IPV4_ADDR(255,255,248,0)
#define IPV4_ADDR_DEFAULT_GW		MAKE_IPV4_ADDR(172,24,8,1)
